...
void SafeDrawSquare(IplImage** image, CvPoint* pt, int radius){
	...
	cvRectangle(img,cvPoint( (pt->x)-radius ,(pt->y)-radius ), cvPoint( (pt->x)+radius ,(pt->y)+radius ),cvScalar( 255, 255, 255 ),1,8,0 );
	}else{
...
int CopyCharArrayToIplImage(const unsigned char *arr, IplImage *dest,  int nsizex,
	...
	//printf("CopyCharArrayToIplImage .....\n");
